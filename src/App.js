export default function App() {
  return (
    <div className="bg-slate-100">
      <div className="w-full max-w-[840px] mx-auto px-4 py-8 sm:px-6 lg:px-8 bg-slate-100">
        <div className="absolute top-5 right-5">
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" fill="currentColor" className="text-slate-600 md:hover:text-slate-700 size-10 md:size-12" viewBox="0 0 48 48">
        ...
        <div className="flex flex-col items-center space-y-4">
          <div className="w-28 h-28 sm:w-40 sm:h-40 rounded-full bg-gray-200 flex items-center justify-center">
            <img src="/baba.png" alt="User" className="w-full h-full rounded-full object-cover ring-2 ring-[#FF00E5]" />
            <span className="sr-only">AC</span>
          </div>
          <div className="text-center space-y-1">
            <h1 className="text-2xl font-bold text-black">@baba</h1>
            <p className="text-gray-600"></p>
            <p className="text-gray-600">CA: <span className="text-xs md:text-base">A7PoiEZCd3HMkA5AoFQ61dybsbzYwb9dToKJjLSnpump</span></p>
            <p className="text-gray-600">baba da baby</p>
            <div className="text-gray-300">
              <div className='flex justify-center items-center z-10'>
                <a href="https://x.com/babadababy" className=''>
                ...
                <a href="https://t.me/babadababy" className=''>
